...
<div class="x_panel">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal form-label-left">
            ...
            <div class="x_title">
                <h2>Agregar Pedido <small></small></h2>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="Cliente" id="Cliente" class="form-control" select2 required>
                            ...
                            <option value="{{$obj->Id}}">{{$obj->Nombre}} {{$obj->Telefono}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" name="FechaDespacho" id="FechaDespacho" class="form-control" autofocus="true" onblur="this.value = this.value.toUpperCase()">
                    </div>
                    <label class="col-sm-3 control-label">&nbsp;</label>
                </div>
